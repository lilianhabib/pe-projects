    ...
    <main>
      <inner-column> 
        <section class='page-section'> 
            ...
            <div class="intro"> 
              <h2 class="bold-voice">Heading level 2 small</h2>
              <p class="tiny-voice">This is some body text. This is some body text. This is some body text. This is some body text.</p> 
            </div>
            ...
            <div class="detail"> 
              <hr>
              <h2 class="loud-voice">Heading level 3 small</h2>
              <p class="tiny-voice">This is some body text. This is some body text. This is some body text. This is some body text.</p> 
            </div>
