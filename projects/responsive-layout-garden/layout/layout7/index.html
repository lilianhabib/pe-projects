    ...
    <main>
      <inner-column> 
        ...
        <section class="page-section"> 
          ...
          <div class="intro"> 
            <span class="tiny-voice">Little teaser</span>
          ...
          <div class="detail-section"> 
            <div class='detail'> 
              ...
              <picture class='detail-square'>
                <img src="https://www.peprojects.dev/images/square.jpg"> 
              </picture>

              <h3 class="bold-voice">Heading level 3 small</h3>
              <p class="attention-voice">This is some body text. This is some body text. This is some body text. This is some body text.</p>
            ...
            <div class='last-detail'> 
              ...
              <hr>
              <p class="small-voice">This is some body text. This is some body text. This is some body text. This is some body text.</p>
